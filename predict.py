...
def set_args():
    ...
    parser.add_argument('--model_variant', type=str, default="phobert-large-all")
    parser.add_argument('--save_file', type=str, default="data/exports/result_mvclip_ver0.9.json", help='save result path')
